<template>
	<view class="container">
		<view class="FixedNavBar" :class="[isFixedTop ? 'FixedNavBar-fixed' : 'FixedNavBar-hidden']">
			<view class="headBox">
				<view class="btn nightMode"></view>
				<view class="nickname">网友123</view>
				<view class="btn setting" @tap="openSetting"></view>
			</view>
		</view>
	...
	.container {
		...
		.SlideNavBar, .FixedNavBar {
			...
			.nightMode {
				...
				background-image: url(../../static/images/nav_night.png);
			}
			.setting {
				background-size: 40rpx 36rpx;
				background-image: url(../../static/images/nav_setting.png);
			}
		}
	}
